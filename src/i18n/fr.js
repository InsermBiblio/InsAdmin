  ...
  resources: {
    ...
    teams: {
      ...
      fields: {
        ...
        nb_researchers_inserm_pp: "nb de chercheur INSERM PP",
        nb_researchers_inserm_etp: "nb de chercheur INSERM ETP",
        nb_researchers_crns_pp: "nb de chercheur CNRS PP",
        nb_researchers_crns_etp: "nb de chercheur CNRS ETP",
        nb_researchers_other_pp: "nb de chercheur autre PP",
        nb_researchers_other_etp: "nb de chercheur autre ETP",
        nb_post_phd_student_pp: "nb d'Post-Doctorant PP",
        nb_post_phd_student_etp: "nb Post-Doctorant ETP",
        nb_phd_student_pp: "nb d'étudiants Doctorant PP",
        nb_phd_student_etp: "nb d'étudiants Doctorant ETP",
        nb_cdi_researchers_pp: "nb de chercheur en CDI PP",
        nb_cdi_researchers_etp: "nb de chercheur en CDI ETP",
        nb_cdd_researchers_pp: "nb de chercheur en CDD PP",
        nb_cdd_researchers_etp: "nb de chercheur en CDD ETP",
        nb_teacher_researchers_pp: "nb de chercheur-professeur PP",
        nb_teacher_researchers_etp: "nb de chercheur-professeur ETP",
        nb_pu_ph_pp: "nb de PU PH PP",
        nb_pu_ph_etp: "nb de PU PH ETP",
        nb_hosp_others_pp: "nb HOSP autre PP",
        nb_hosp_others_etp: "nb HOSP autre ETP",
        ...
        nb_cdd_others_pp: "nb CDD autre PP",
        nb_cdd_others_etp: "nb CDD autre ETP",
